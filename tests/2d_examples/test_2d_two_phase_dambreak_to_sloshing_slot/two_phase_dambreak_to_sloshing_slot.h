...
Real baffle_scale = 1.0e-3;
std::vector<Vecd> createBaffleShape()
{
    std::vector<Vecd> baffle_shape;
    baffle_shape.push_back(Vecd(-26.5, 0.0) * baffle_scale);
    baffle_shape.push_back(Vecd(-26.5, 6.0) * baffle_scale);
    baffle_shape.push_back(Vecd(-19.0, 6.0) * baffle_scale);
    baffle_shape.push_back(Vecd(-19.0, 12.5) * baffle_scale);
    baffle_shape.push_back(Vecd(-11.0, 12.5) * baffle_scale);
    baffle_shape.push_back(Vecd(-11.0, 26.0) * baffle_scale);
    baffle_shape.push_back(Vecd(-3.0, 26.0) * baffle_scale);
    baffle_shape.push_back(Vecd(-3.0, 6.0) * baffle_scale);
    baffle_shape.push_back(Vecd(3.0, 6.0) * baffle_scale);
    baffle_shape.push_back(Vecd(3.0, 26.0) * baffle_scale);
    baffle_shape.push_back(Vecd(11.0, 26.0) * baffle_scale);
    baffle_shape.push_back(Vecd(11.0, 12.5) * baffle_scale);
...
class WallBoundary : public ComplexShape
{
  public:
    explicit WallBoundary(const std::string &shape_name) : ComplexShape(shape_name)
    {
        ...
        add<MultiPolygonShape>(MultiPolygon(createBaffleShape()), "Baffle");
    }
};
...
StdVec<Vecd> tank_pressure_observation_location = {Vecd(0.5 * DL + h_solid, 0.165), Vecd(0.5 * DL + h_solid, 0.220)};
