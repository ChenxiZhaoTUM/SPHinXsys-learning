/**
 * @file    NCCV_2phase_periodic_python.cpp
 * @brief
 * @author
 */
#include "NCCV_2phase_periodic_python.h"
...
class SphBodyReloadEnvironment : public SphBasicSystemSetting
{
  protected:
    ...
    SolidBody wall_boundary, up_Dirichlet, down_Dirichlet;
...
class SphNaturalConvection : public SphBodyReloadEnvironment
{
  ...
  protected:
    ...
    ContactRelation phase_1_contact_up_Dirichlet, phase_1_contact_down_Dirichlet, phase_1_contact_wall_boundary, phase_1_contact_two, phase_1_contacts,
        phase_2_contact_up_Dirichlet, phase_2_contact_down_Dirichlet, phase_2_contact_wall_boundary, phase_2_contact_one, phase_2_contacts,
    ...
    PeriodicAlongAxis phase_1_periodic_along_x;
    PeriodicConditionUsingCellLinkedList phase_1_periodic_condition;
    PeriodicAlongAxis phase_2_periodic_along_x;
    PeriodicConditionUsingCellLinkedList phase_2_periodic_condition;
  ...
  public:
    explicit SphNaturalConvection(int parallel_env, int episode_env, int set_restart_step = 0)
        : SphBodyReloadEnvironment(parallel_env, episode_env, set_restart_step),
          ...
          phase_1_complex(phase_1_inner, {&phase_1_contact_up_Dirichlet, &phase_1_contact_down_Dirichlet, &phase_1_contact_wall_boundary, &phase_1_contact_two, &phase_1_contacts}),
          phase_2_complex(phase_2_inner, {&phase_2_contact_up_Dirichlet, &phase_2_contact_down_Dirichlet, &phase_2_contact_wall_boundary, &phase_2_contact_one, &phase_2_contacts}),
          ...
          // thermal dynamics
          phase_1_temperature_relaxation(phase_1_inner, phase_1_contact_two, phase_1_contact_up_Dirichlet, phase_1_contact_down_Dirichlet),
          phase_1_thermal_time_step(PhaseOne_diffusion_body),
          phase_1_initial_condition(PhaseOne_diffusion_body),

          phase_2_temperature_relaxation(phase_2_inner, phase_2_contact_one, phase_2_contact_up_Dirichlet, phase_2_contact_down_Dirichlet),
          ...
          // fluid dynamics
          phase_1_kernel_correction_complex(InteractArgs(phase_1_inner, 0.1), phase_1_contacts),
          phase_2_kernel_correction_complex(InteractArgs(phase_2_inner, 0.1), phase_2_contacts),
          ...
          bounding_box(Vec2d(0.0, -H / 2), Vec2d(L, H / 2)),
          phase_1_periodic_along_x(bounding_box, xAxis),
          phase_1_periodic_condition(PhaseOne_diffusion_body, phase_1_periodic_along_x),
          phase_2_periodic_along_x(bounding_box, xAxis),
          phase_2_periodic_condition(PhaseTwo_diffusion_body, phase_2_periodic_along_x),
...
//----------------------------------------------------------------------
PYBIND11_MODULE(zcx_2d_NCCV_2phase_periodic_python, m)
{
