...
class BidirectionalBufferWithWindkessel
{
  protected:
    ...
    {
      public:
        Injection(BodyAlignedBoxByCell &aligned_box_part, const std::string &body_part_name, ParticleBuffer<Base> &particle_buffer,
  ...
  public:
    BidirectionalBufferWithWindkessel(BodyAlignedBoxByCell &aligned_box_part, const std::string &body_part_name, ParticleBuffer<Base> &particle_buffer)
        : target_pressure_(*this), tag_buffer_particles(aligned_box_part),
          injection(aligned_box_part, body_part_name, particle_buffer, target_pressure_){};
    virtual ~BidirectionalBufferWithWindkessel(){};

    SimpleDynamics<TagBufferParticles, ExecutionPolicy> tag_buffer_particles;
    SimpleDynamics<Injection, ExecutionPolicy> injection;
};

using NonPrescribedPressureBidirectionalBufferWithWindkessel = BidirectionalBufferWithWindkessel<fluid_dynamics::NonPrescribedPressure>;
...
int main(int ac, char *av[])
{
    ...
    SimpleDynamics<DisposerOutflowDeletionWithWindkessel> disposer_outflow_deletion_1(disposer_1, "out01");
    ...
    SimpleDynamics<DisposerOutflowDeletionWithWindkessel> disposer_outflow_deletion_2(disposer_2, "out02");
    ...
    SimpleDynamics<DisposerOutflowDeletionWithWindkessel> disposer_outflow_deletion_3(disposer_3, "out03");
    ...
    SimpleDynamics<DisposerOutflowDeletionWithWindkessel> disposer_outflow_deletion_4(disposer_4, "out04");
    ...
    SimpleDynamics<DisposerOutflowDeletionWithWindkessel> disposer_outflow_deletion_5(disposer_5, "out05");
    ...
    NonPrescribedPressureBidirectionalBufferWithWindkessel outflow_injection_1(outflow_emitter_1, "out01", in_outlet_particle_buffer);
    ...
    NonPrescribedPressureBidirectionalBufferWithWindkessel outflow_injection_2(outflow_emitter_2, "out02", in_outlet_particle_buffer);
    ...
    NonPrescribedPressureBidirectionalBufferWithWindkessel outflow_injection_3(outflow_emitter_3, "out03", in_outlet_particle_buffer);
    ...
    NonPrescribedPressureBidirectionalBufferWithWindkessel outflow_injection_4(outflow_emitter_4, "out04", in_outlet_particle_buffer);
    ...
    NonPrescribedPressureBidirectionalBufferWithWindkessel outflow_injection_5(outflow_emitter_5, "out05", in_outlet_particle_buffer);
    ...
    SimpleDynamics<OutflowPressure> outflow_pressure_condition1(outflow_emitter_1, "out01",
        1.18E8, 1.84E9, 7.7E-10, 0.006, 0.0000098);
    SimpleDynamics<OutflowPressure> outflow_pressure_condition2(outflow_emitter_2, "out02", 
        1.04E8, 1.63E9, 8.74E-10, 0.006, 0.00001);
    SimpleDynamics<OutflowPressure> outflow_pressure_condition3(outflow_emitter_3, "out03", 
        1.18E8, 1.84E9, 7.7E-10, 0.006, 0.0000068);
    SimpleDynamics<OutflowPressure> outflow_pressure_condition4(outflow_emitter_4, "out04", 
        9.7E7, 1.52E9, 9.34E-10, 0.006, 0.0000118);
    SimpleDynamics<OutflowPressure> outflow_pressure_condition5(outflow_emitter_5, "out05", 
