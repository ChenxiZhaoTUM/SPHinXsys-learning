...
class SolidBodyFromMesh : public ComplexShape
{
  public:
    ...
    {
        add<ExtrudeShape<TriangleMeshShapeSTL>>(wall_thickness-wall_resolution/2, full_path_to_file, translation_fluid, scale);
        subtract<ExtrudeShape<TriangleMeshShapeSTL>>(-wall_resolution/2, full_path_to_file, translation_fluid, scale);
