...
int main(int ac, char *av[])
{
    ...
    SimpleDynamics<fluid_dynamics::WindkesselBoundaryConditionQave> outflow_pressure_condition1(outflow_emitter_1);
    SimpleDynamics<fluid_dynamics::WindkesselBoundaryConditionQave> outflow_pressure_condition2(outflow_emitter_2);
    SimpleDynamics<fluid_dynamics::WindkesselBoundaryConditionQave> outflow_pressure_condition3(outflow_emitter_3);
    SimpleDynamics<fluid_dynamics::WindkesselBoundaryConditionQave> outflow_pressure_condition4(outflow_emitter_4);
    SimpleDynamics<fluid_dynamics::WindkesselBoundaryConditionQave> outflow_pressure_condition5(outflow_emitter_5);
