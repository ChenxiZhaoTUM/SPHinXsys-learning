...
Real Re = 400;                      /**< Reynolds number. */
Real mu_f = 2 * Pi * DL * rho0_f * U_f / Re; /**< Dynamics viscosity. */
//----------------------------------------------------------------------
...
int main(int ac, char *av[])
{
    ...
    water_block.addBodyStateForRecording<Real>("VorticityInner");
    ...
    InteractionDynamics<LocalDisorderMeasureForPeriodicCondition> local_disorder_measure(water_block_inner, DL, DH);
    ...
    while (GlobalStaticVariables::physical_time_ < end_time)
    {
        ...
        write_global_disorder_measure.writeToFile(number_of_iterations);
