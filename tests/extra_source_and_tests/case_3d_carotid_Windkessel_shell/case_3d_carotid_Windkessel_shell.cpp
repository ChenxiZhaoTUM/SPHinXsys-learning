...
Vec3d outlet_down_buffer_translation = Vec3d(-2.6975, -0.4330, 21.7855) * scaling - outlet_down_normal * (2.5 * dp_0);
...
Vec3d outlet_up_buffer_translation = Vec3d(9.0220, 0.9750, 18.6389) * scaling - outlet_up_normal * (2.5 * dp_0);
