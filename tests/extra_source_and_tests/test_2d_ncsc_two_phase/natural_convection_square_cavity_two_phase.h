...
Real mu_f_up = 1.506E-5 * rho0_f * 1.2;
Real mu_f_down = 1.506E-5 * rho0_f * 0.8;
Real C_p = 1.006E3;
Real k = 0.02587;
...
class WallBoundary : public MultiPolygonShape
{
  public:
    explicit WallBoundary(const std::string &shape_name) : MultiPolygonShape(shape_name)
    {
        ...
        multi_polygon_.addAPolygon(createThermalDomainUp(), ShapeBooleanOps::sub);
        multi_polygon_.addAPolygon(createThermalDomainDown(), ShapeBooleanOps::sub);
    }
};
