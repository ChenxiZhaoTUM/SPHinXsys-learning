...
class BidirectionalBufferWindkessel
{
  ...
  public:
    BidirectionalBufferWindkessel(BodyAlignedBoxByCell &aligned_box_part, ParticleBuffer<Base> &particle_buffer, Real R1, Real R2, Real C, Real radius)
        : target_pressure_(TargetPressure(aligned_box_part, R1, R2, C, radius)), tag_buffer_particles(aligned_box_part),
          injection(aligned_box_part, particle_buffer, target_pressure_){};
