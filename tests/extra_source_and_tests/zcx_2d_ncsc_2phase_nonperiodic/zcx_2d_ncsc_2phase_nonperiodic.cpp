/**
 * @file 	zcx_2d_ncsc_2phase_nonperiodic.cpp
 * @brief 	
 * @details 
 * @author 	
 */
#include "zcx_2d_ncsc_2phase_nonperiodic.h"
...
int main(int ac, char *av[])
{
    ...
    SolidBody wall_Neumann(sph_system, makeShared<NeumannBoundary>("NeumannBoundary"));
    ...
    ContactRelation phase_1_contact_Neumann(PhaseOne_diffusion_body, {&wall_Neumann});
    ...
    ContactRelation phase_2_contact_Neumann(PhaseTwo_diffusion_body, {&wall_Neumann});
    ...
    ComplexRelation phase_1_complex(phase_1_inner, {&phase_1_contact_up_Dirichlet, &phase_1_contact_down_Dirichlet, &phase_1_contact_Neumann, 
        &phase_1_contact_wall_boundary, &phase_1_contact_two, &phase_1_contacts});
    ComplexRelation phase_2_complex(phase_2_inner, {&phase_2_contact_up_Dirichlet, &phase_2_contact_down_Dirichlet, &phase_2_contact_Neumann, 
    ...
    MultiPhaseDiffusionBodyRelaxation phase_1_temperature_relaxation(
        phase_1_inner, phase_1_contact_two, phase_1_contact_up_Dirichlet, phase_1_contact_down_Dirichlet, phase_1_contact_Neumann);
    ...
    MultiPhaseDiffusionBodyRelaxation phase_2_temperature_relaxation(
        phase_2_inner, phase_2_contact_one, phase_2_contact_up_Dirichlet, phase_2_contact_down_Dirichlet, phase_2_contact_Neumann);
    ...
    SimpleDynamics<NeumannWallBoundaryInitialCondition> setup_Neumann_initial_condition(wall_Neumann);
    ...
    BodyRegionByParticle middle_wall_domain(down_Dirichlet, makeShared<MultiPolygonShape>(createMiddleDownWallDomain(), "MiddleWallDomain"));
    ReducedQuantityRecording<solid_dynamics::AveragedWallNu<BodyRegionByParticle>> write_local_middle_average_Nu(middle_wall_domain, "WallLocalNusseltNumber");
    BodyRegionByParticle right_wall_domain(down_Dirichlet, makeShared<MultiPolygonShape>(createRightDownWallDomain(), "RightWallDomain"));
    ReducedQuantityRecording<solid_dynamics::AveragedWallNu<BodyRegionByParticle>> write_local_right_average_Nu(right_wall_domain, "WallLocalNusseltNumber");
    ...
    while (physical_time < End_Time)
    {
        ...
        write_local_middle_average_Nu.writeToFile();
        write_local_right_average_Nu.writeToFile();
