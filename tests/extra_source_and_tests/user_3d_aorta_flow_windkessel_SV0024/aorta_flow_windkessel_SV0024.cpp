...
Vec3d outlet_1_buffer_translation = outlet_1_center - outlet_1_normal * (2.0 * dp_0 + 0.5 * dp_0);
...
Vec3d outlet_2_buffer_translation = outlet_2_center - outlet_2_normal * (2.0 * dp_0 + 0.5 * dp_0);
...
Vec3d outlet_3_buffer_translation = outlet_3_center - outlet_3_normal * (2.0 * dp_0 + 0.5 * dp_0);
...
Vec3d outlet_4_buffer_translation = outlet_4_center - outlet_4_normal * (2.0 * dp_0 + 0.5 * dp_0);
...
Vec3d outlet_5_buffer_translation = outlet_5_center - outlet_5_normal * (2.0 * dp_0 + 0.5 * dp_0);
...
int main(int ac, char *av[])
{
    ...
    // 100mmHg => Qref
    outflow_pressure_condition1.getTargetPressure()->setWindkesselParams(0.713E8, 8.256E-10, 1.2023E9, accumulated_time, 1.05E-05);
    outflow_pressure_condition2.getTargetPressure()->setWindkesselParams(0.713E8, 8.256E-10, 1.2023E9, accumulated_time, 1.05E-05);
    outflow_pressure_condition3.getTargetPressure()->setWindkesselParams(0.602E8, 9.785E-10, 1.0143E9, accumulated_time, 1.24E-05);
    outflow_pressure_condition4.getTargetPressure()->setWindkesselParams(0.689E8, 8.55E-10, 1.1609E9, accumulated_time, 1.08E-05);
    outflow_pressure_condition5.getTargetPressure()->setWindkesselParams(0.98E7, 6.0154E-9, 1.65E8, accumulated_time, 7.63E-05);
