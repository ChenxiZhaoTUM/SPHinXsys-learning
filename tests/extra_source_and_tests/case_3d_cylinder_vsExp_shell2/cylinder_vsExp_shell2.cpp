...
Real U_max = 1.5 * U_f;  // parabolic inflow, Thus U_max = 2*U_f
...
struct InflowVelocity
{
    ...
    Vecd operator()(Vecd &position, Vecd &velocity, Real current_time)
    {
        ...
        u_ave = Q * 0.211E-3/60 / (Pi * fluid_radius * fluid_radius);
...
StdVec<Vecd> displacement_observation_location = {
    Vecd(fluid_radius + 0.5 * resolution_shell, 0.5 * full_length, 0.0)};
