/**
 * @file 	case_3d_stenosed_VIPO_shell.cpp
 * @brief
 * @details
 * @author
 */
...
Real Youngs_modulus = 1.0e10; /** Normalized Youngs Modulus. */
...
int main(int ac, char *av[])
{
    ...
    BoundaryGeometry boundary_geometry(shell_boundary, "BoundaryGeometry", 4.0*resolution_ref);
