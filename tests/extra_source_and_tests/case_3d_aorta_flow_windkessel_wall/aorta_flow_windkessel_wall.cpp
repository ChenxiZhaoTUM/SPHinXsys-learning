...
Vec3d inlet_center = Vec3d(-0.9768, 4.6112, 3.0052) * scaling - inlet_normal * (2.2 * dp_0);
...
Vec3d outlet_1_cut_translation = outlet_1_center + outlet_1_normal * (1.0 * dp_0);
...
Vec3d outlet_4_cut_translation = outlet_4_center + outlet_4_normal * (1.0 * dp_0);
...
Vec3d outlet_5_cut_translation = outlet_5_center + outlet_5_normal * (1.2 * dp_0);
...
int main(int ac, char *av[])
{
    ...
    fluid_dynamics::BidirectionalBufferArb<AlignedCylinderShape, fluid_dynamics::NonPrescribedPressure> inflow_injection(inlet_emitter, in_outlet_particle_buffer);
