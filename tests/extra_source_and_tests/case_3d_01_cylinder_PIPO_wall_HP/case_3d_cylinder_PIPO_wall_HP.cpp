/**
 * @file 	case_3d_cylinder_PIPO_wall_HP.cpp
 * @brief 
 * @details
 * @author 
 */
...
//----------------------------------------------------------------------
struct LeftOutflowPressure
{
    template <class BoundaryConditionType>
    LeftOutflowPressure(BoundaryConditionType &boundary_condition) {}
...
StdVec<Vecd> displacement_observation_location = {
    Vecd(1.5 * scale, fluid_radius + 0.5 * wall_thickness, 0.0), Vecd(2.5 * scale, fluid_radius + 0.5 * wall_thickness, 0.0), Vecd(3.5 * scale, fluid_radius + 0.5 * wall_thickness, 0.0)};
...
int main(int ac, char *av[])
{
    ...
    fluid_dynamics::BidirectionalBuffer<LeftOutflowPressure> left_bidirection_buffer(left_buffer, in_outlet_particle_buffer);
    ...
    SimpleDynamics<fluid_dynamics::PressureCondition<LeftOutflowPressure>> left_pressure_condition(left_buffer);
