...
int main(int ac, char *av[])
{
    ...
    //InteractionDynamics<solid_dynamics::WallLocalNusseltNumberByFlux> wall_local_nusselt_number(Dirichlet_contact, L/(left_temperature - right_temperature));
    //InteractionDynamics<solid_dynamics::FFDForNu> wall_local_nusselt_number(Dirichlet_contact, L/(left_temperature - right_temperature));
    InteractionDynamics<solid_dynamics::ProjectionForNu> wall_local_nusselt_number(Dirichlet_contact, L/(left_temperature - right_temperature));
    //----------------------------------------------------------------------
