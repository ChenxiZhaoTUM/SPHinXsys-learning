...
int main(int ac, char *av[])
{
    ...
    // why -average_Q??
    SimpleDynamics<fluid_dynamics::WindkesselModel> windkessel_outlet_1(disposer_1, "out01", 1.18E8, 1.84E9, 7.7E-10, accumulated_time, 0.0000098);
    ...
    SimpleDynamics<fluid_dynamics::WindkesselModel> windkessel_outlet_2(disposer_2, "out02", 1.04E8, 1.63E9, 8.74E-10, accumulated_time, 0.00001);
    ...
    SimpleDynamics<fluid_dynamics::WindkesselModel> windkessel_outlet_3(disposer_3, "out03", 1.18E8, 1.84E9, 7.7E-10, accumulated_time, 0.0000068);
    ...
    SimpleDynamics<fluid_dynamics::WindkesselModel> windkessel_outlet_4(disposer_4, "out04", 9.7E7, 1.52E9, 9.34E-10, accumulated_time, 0.0000118);
    ...
    SimpleDynamics<fluid_dynamics::WindkesselModel> windkessel_outlet_5(disposer_5, "out05", 1.88E7, 2.95E8, 4.82E-9, accumulated_time, 0.00009668);
    ...
    fluid_dynamics::BidirectionalBufferByWindkesselModel outflow_injection_1(outflow_emitter_1, in_outlet_particle_buffer, windkessel_outlet_1);
    ...
    fluid_dynamics::BidirectionalBufferByWindkesselModel outflow_injection_2(outflow_emitter_2, in_outlet_particle_buffer, windkessel_outlet_2);
    ...
    fluid_dynamics::BidirectionalBufferByWindkesselModel outflow_injection_3(outflow_emitter_3, in_outlet_particle_buffer, windkessel_outlet_3);
    ...
    fluid_dynamics::BidirectionalBufferByWindkesselModel outflow_injection_4(outflow_emitter_4, in_outlet_particle_buffer, windkessel_outlet_4);
    ...
    fluid_dynamics::BidirectionalBufferByWindkesselModel outflow_injection_5(outflow_emitter_5, in_outlet_particle_buffer, windkessel_outlet_5);
    ...
    SimpleDynamics<fluid_dynamics::PressureConditionByWindekesselModel> outflow_pressure_condition1(outflow_emitter_1, windkessel_outlet_1);
    SimpleDynamics<fluid_dynamics::PressureConditionByWindekesselModel> outflow_pressure_condition2(outflow_emitter_2, windkessel_outlet_2);
    SimpleDynamics<fluid_dynamics::PressureConditionByWindekesselModel> outflow_pressure_condition3(outflow_emitter_3, windkessel_outlet_3);
    SimpleDynamics<fluid_dynamics::PressureConditionByWindekesselModel> outflow_pressure_condition4(outflow_emitter_4, windkessel_outlet_4);
    SimpleDynamics<fluid_dynamics::PressureConditionByWindekesselModel> outflow_pressure_condition5(outflow_emitter_5, windkessel_outlet_5);
    ...
    */
    while (GlobalStaticVariables::physical_time_ < end_time)
    {
        ...
        {  
            ...
            windkessel_outlet_1.exec();
            windkessel_outlet_2.exec();
            windkessel_outlet_3.exec();
            windkessel_outlet_4.exec();
            windkessel_outlet_5.exec();
