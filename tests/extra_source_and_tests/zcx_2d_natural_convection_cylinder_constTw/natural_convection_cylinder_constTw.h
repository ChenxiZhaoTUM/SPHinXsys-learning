/**
 * @file 	natural_convection_cylinder_constTw.h
 * @brief
 * @author
 */
...
Real inner_circle_radius = 0.031;       /**< Radius of the cylinder. */
Real resolution_ref = inner_circle_radius / 50.0;
...
//----------------------------------------------------------------------
Real rho0_f = 1.18;                  /**< Reference density of fluid. */
Real mu_f = 1.50E-5 * rho0_f;               /**< Dynamics viscosity. */
Real C_p = 1.0068E3;
Real diffusion_coeff = 2.09E-5;  //thermal diffusivity
Real thermal_expansion_coeff = 3.33E-3;
std::string diffusion_species_name = "Phi";
//----------------------------------------------------------------------
//	Initial and boundary conditions.
//----------------------------------------------------------------------
Real initial_temperature = 300;
Real wall_temperature = 280.8;
