/**
 * @file 	case_2d_channel_ResistanceBC_elastic_wall.cpp
 * @brief 
 * @details
 * @author 
 */
...
StdVec<Vecd> displacement_observation_location = {
    Vecd(5.0 * scale, DH + 0.5 * wall_thickness),
    Vecd(10.0 * scale, DH + 0.5 * wall_thickness),
    Vecd(15.0 * scale, DH + 0.5 * wall_thickness),
    Vecd(20.0 * scale, DH + 0.5 * wall_thickness),
    Vecd(25.0 * scale, DH + 0.5 * wall_thickness)
};
