/**
 * @file    br_2d_bubble_rising_bottom_python.cpp
 * @brief   Python-callable wrapper for bubble_rising_heat.
 */

#include "br_2d_bubble_rising_bottom_python.h"
...
class SphBodyReloadEnvironment : public SphBasicSystemSetting
{
  protected:
    ...
    SolidBody bottom_Dirichlet;
    SolidBody top_Dirichlet;
  ...
  public:
    SphBodyReloadEnvironment(
        ...
        : SphBasicSystemSetting(
          ...
          bottom_Dirichlet(sph_system, makeShared<BottomDirichletWall>("BottomDirichlet")),
          top_Dirichlet(sph_system, makeShared<TopDirichletWall>("TopDirichlet")),
          flow_observer(sph_system, "FlowObserver")
    {
        ...
        bottom_Dirichlet.defineMaterial<Solid>();
        bottom_Dirichlet.generateParticles<BaseParticles, Lattice>();

        top_Dirichlet.defineMaterial<Solid>();
        top_Dirichlet.generateParticles<BaseParticles, Lattice>();
    ...
    SolidBody &getBottomDirichletWall()
    {
        return bottom_Dirichlet;
    }

    SolidBody &getTopDirichletWall()
    {
        return top_Dirichlet;
    }
};
...
class SphBubbleRisingHeat : public SphBodyReloadEnvironment
{
  protected:
    ...
    ContactRelation liquid_contact_bottom_Dirichlet;
    ContactRelation liquid_contact_top_Dirichlet;
    ...
    ContactRelation bubble_contact_bottom_Dirichlet;
    ContactRelation bubble_contact_top_Dirichlet;
    ...
    SimpleDynamics<NormalDirectionFromBodyShape> bottom_Dirichlet_normal_direction;
    SimpleDynamics<NormalDirectionFromBodyShape> top_Dirichlet_normal_direction;
    ...
    SimpleDynamics<DirichletWallBoundaryInitialCondition>
        setup_bottom_Dirichlet_initial_condition;
    SimpleDynamics<DirichletWallBoundaryInitialCondition>
        setup_top_Dirichlet_initial_condition;
  ...
  public:
    explicit SphBubbleRisingHeat(
        ...
        : SphBodyReloadEnvironment(
          ...
          liquid_contact_bottom_Dirichlet(liquid_body, {&bottom_Dirichlet}),
          liquid_contact_top_Dirichlet(liquid_body, {&top_Dirichlet}),
          ...
          bubble_contact_bottom_Dirichlet(bubble_body, {&bottom_Dirichlet}),
          bubble_contact_top_Dirichlet(bubble_body, {&top_Dirichlet}),
          ...
          liquid_complex(
              ...
              {&liquid_contact_bubble,
               ...
               &liquid_contact_bottom_Dirichlet,
               &liquid_contact_top_Dirichlet}),
          bubble_complex(
              bubble_inner,
              {&bubble_contact_liquid,
               &bubble_contact_wall,
               &bubble_contact_no_slip_wall,
               &bubble_contact_bottom_Dirichlet,
               &bubble_contact_top_Dirichlet}),
          ...
          bottom_Dirichlet_normal_direction(bottom_Dirichlet),
          top_Dirichlet_normal_direction(top_Dirichlet),
          ...
          setup_bottom_Dirichlet_initial_condition(bottom_Dirichlet),
          setup_top_Dirichlet_initial_condition(top_Dirichlet),
          ...
          bubble_metrics_calculator(bubble_body)
    {
        ...
        if (write_output_)
        {
            ...
            write_states.addToWrite<Real>(bottom_Dirichlet, diffusion_species_name);
            write_states.addToWrite<Real>(top_Dirichlet, diffusion_species_name);
        }
        ...
        setup_bottom_Dirichlet_initial_condition.exec();
        setup_top_Dirichlet_initial_condition.exec();
        ...
        bottom_Dirichlet_normal_direction.exec();
        top_Dirichlet_normal_direction.exec();
    ...
    //--------------------------------------------------------------------------
    // Bottom-wall segmented temperature control.
    //--------------------------------------------------------------------------
    void setBottomWallSegmentTemperatures(
        ...
        Real mean_temperature = 1.0)
    {
        ...
        SphBasicGeometrySetting::setBottomWallSegmentTemperatures(
            temperatures,
            enforce_mean,
            mean_temperature);
    ...
    void setBottomWallSegmentActions(
        ...
        Real mean_temperature = 1.0)
    {
        ...
        SphBasicGeometrySetting::setBottomWallSegmentActions(
            actions,
            amplitude,
            mean_temperature);
    ...
    StdVec<Real> getBottomWallSegmentTemperatures() const
    {
        return SphBasicGeometrySetting::bottom_wall_segment_T;
    }
    ...
    int debugSmokeTest()
    {
        ...
        std::cout << "[1] setBottomWallSegmentActions ...\n";
        setBottomWallSegmentActions(actions, 0.3, 1.0);
...
PYBIND11_MODULE(br_2d_bubble_rising_bottom_python, m)
{
    ...
    py::class_<SphBubbleRisingHeat>(m, "bubble_rising_heat_from_sph_cpp")
        ...
        .def(
            "set_bottom_wall_segment_temperatures",
            &SphBubbleRisingHeat::setBottomWallSegmentTemperatures,
            py::arg("temperatures"),
            py::arg("enforce_mean") = true,
            py::arg("mean_temperature") = 1.0)

        .def(
            "set_bottom_wall_segment_actions",
            &SphBubbleRisingHeat::setBottomWallSegmentActions,
            py::arg("actions"),
        ...
        .def(
            ...
            &SphBubbleRisingHeat::getBottomWallSegmentTemperatures)
