...
int main(int ac, char *av[])
{
    ...
    SimpleDynamics<fluid_dynamics::InflowVelocityCondition<InflowVelocity>> left_inflow_velocity_condition(left_emitter);
    ...
    while (GlobalStaticVariables::physical_time_ < end_time)
    {
        ...
        while (integration_time < Output_Time)
        {
            ...
            while (relaxation_time < Dt)
            {
                ...
                left_inflow_velocity_condition.exec(dt);
