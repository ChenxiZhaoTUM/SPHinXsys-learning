/**
 * @file 	case_3d_cylinder_cVIcPO_elastic_wall.cpp
 * @brief 
 * @details
 * @author 
 */
...
StdVec<Vecd> displacement_observation_location = {
    Vecd(0.5 * scale, fluid_radius + 0.5 * wall_thickness, 0.0), 
    Vecd(1.0 * scale, fluid_radius + 0.5 * wall_thickness, 0.0), 
    Vecd(1.5 * scale, fluid_radius + 0.5 * wall_thickness, 0.0), 
    Vecd(2.0 * scale, fluid_radius + 0.5 * wall_thickness, 0.0), 
    Vecd(2.5 * scale, fluid_radius + 0.5 * wall_thickness, 0.0), 
