...
//----------------------------------------------------------------------
std::string full_path_to_stl_file01 = "./input/starfish_3D.stl";
std::string full_path_to_stl_file02 = "./input/starfish_3D_water.stl";
//----------------------------------------------------------------------
...
class Bunny : public ComplexShape
{
  public:
    ...
    {
        add<TriangleMeshShapeSTL>(full_path_to_stl_file01, Vecd(0.0, 0.0, 0.0), 1.0);
    }
};
...
class WaterBlock : public ComplexShape
{
  public:
    ...
    {
        add<TriangleMeshShapeSTL>(full_path_to_stl_file02, Vecd(0.0, 0.0, 0.0), 1.0);
    }
};
