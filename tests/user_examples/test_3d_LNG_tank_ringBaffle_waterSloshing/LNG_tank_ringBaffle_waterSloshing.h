/**
 * @file 	LNG_tank_ringBaffle_waterSloshing.h
 * @brief 	Sloshing in marine LNG fuel tank under roll excitation
 * @author
 */

#ifndef LNG_TANK_RING_BAFFLE_WATERSLOSHING_H
#define LNG_TANK_RING_BAFFLE_WATERSLOSHING_H
...
#endif // LNG_TANK_RING_BAFFLE_WATERSLOSHING_H