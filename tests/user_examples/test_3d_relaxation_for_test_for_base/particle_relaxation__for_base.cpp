...
int main()
{
   ...
   // RealBody imported_model(system, makeShared<SolidBodyFromMesh>("WaterBody"));  //WATER!!
    ...
    //imported_model.defineParticlesAndMaterial<BaseParticles, WeaklyCompressibleFluid>(rho0_f, c_f, mu_f);  //WATER!!
    imported_model.defineParticlesAndMaterial<BaseParticles, WeaklyCompressibleFluid>(rho0_a, c_f, mu_a);
