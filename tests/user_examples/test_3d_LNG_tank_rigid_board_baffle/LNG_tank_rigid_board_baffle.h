/**
 * @file 	LNG_tank_rigid_board_baffle.h
 * @brief 	Sloshing in marine LNG fuel tank under roll excitation
 * @author	
 */

#ifndef LNG_TANK_RIGID_BOARD_BAFFLE_H
#define LNG_TANK_RIGID_BOARD_BAFFLE_H
...
std::string fuel_tank_inner = "./input/tank_inner_with_board_baffle.STL";
std::string water_05 = "./input/tank_inner_with_board_baffle_water.STL";
std::string air_05 = "./input/tank_inner_with_board_baffle_air.STL";
...
#endif // LNG_TANK_RIGID_BOARD_BAFFLE_H