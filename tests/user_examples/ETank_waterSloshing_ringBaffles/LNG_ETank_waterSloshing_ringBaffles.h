/**
 * @file 	LNG_ETank_waterSloshing_ringBaffles.h
 * @brief 	Sloshing in marine LNG fuel tank with elastic material under roll excitation, add 2 ring baffles
 * @author
 */

#ifndef LNG_ETANK_WATERSLOSHING_RINGBAFFLES_H
#define LNG_ETANK_WATERSLOSHING_RINGBAFFLES_H
...
#endif // LNG_ETANK_WATERSLOSHING_RINGBAFFLES_H